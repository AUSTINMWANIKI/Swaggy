package com.austin.swaggy.ui.screens.intent
    ...
    Scaffold(
        ...
        content = {
            ...
            Column(
                ...
                Text(
                    text = "Interact with system app like messaging, emailing and more",
                    fontSize = 15.sp,
                    modifier = Modifier.padding(start = 20.dp)
                )
                ...
                Text(
                    text = "Tip: Intents help your app perform actions outside the boundary.",
                    fontSize = 15.sp,
                    modifier = Modifier.padding(start = 20.dp)
                )
